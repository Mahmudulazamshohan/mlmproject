                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <div class="card-10">
                                            ...
                                            <form action="{{route('admin.store.manage-news')}}" method="POST">
                                                ...
                                                <input type="text" name="title" class="form-control input-sm" style="margin-bottom: 10px;"/>
                                                <label for="">
                                                    Text
                                                </label>
                                                <textarea name="text" id="text-editor" cols="50" rows="10"
                                                          class="form-control text-responsive"> </textarea>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($pushNotification->title)
                                                                <?=substr($pushNotification->title,0,100)?>
                                                            @endif
